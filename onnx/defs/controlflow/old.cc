...
ONNX_OPERATOR_SET_SCHEMA(
    If,
    24,
    OpSchema().FillUsing(If_v24_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    If,
    23,
    OpSchema().FillUsing(If_v23_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    If,
    21,
    OpSchema().FillUsing(If_v21_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    If,
    19,
    OpSchema().FillUsing(If_v19_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    If,
    16,
    OpSchema().FillUsing(If_v16_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    24,
    OpSchema().FillUsing(Loop_v24_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    23,
    OpSchema().FillUsing(Loop_v23_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    21,
    OpSchema().FillUsing(Loop_v21_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    19,
    OpSchema().FillUsing(Loop_v19_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    16,
    OpSchema().FillUsing(Loop_v16_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction));

ONNX_OPERATOR_SET_SCHEMA(
    Scan,
    24,
    OpSchema()
        .FillUsing(Scan_v24_FillSpec)
...
ONNX_OPERATOR_SET_SCHEMA(
    Scan,
    8,
    OpSchema().FillUsing(Scan_v8_FillSpec).TypeAndShapeInferenceFunction(ScanInferenceFunction_opset8));
...
ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    1,
    OpSchema().FillUsing(Loop_v1_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction_opset8));
...
ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    11,
    OpSchema().FillUsing(Loop_v11_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction_opset11));

ONNX_OPERATOR_SET_SCHEMA(
    Scan,
    9,
    OpSchema().FillUsing(Scan_v9_FillSpec).TypeAndShapeInferenceFunction(ScanInferenceFunction_opset9));
...
ONNX_OPERATOR_SET_SCHEMA(
    If,
    1,
    OpSchema().FillUsing(If_v1_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction_opset1));
...
ONNX_OPERATOR_SET_SCHEMA(
    If,
    11,
    OpSchema().FillUsing(If_v11_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction_opset11));
...
ONNX_OPERATOR_SET_SCHEMA(
    If,
    13,
    OpSchema().FillUsing(If_v13_FillSpec).TypeAndShapeInferenceFunction(IfInferenceFunction_opset13));
...
ONNX_OPERATOR_SET_SCHEMA(
    Loop,
    13,
    OpSchema().FillUsing(Loop_v13_FillSpec).TypeAndShapeInferenceFunction(LoopInferenceFunction_opset13));

ONNX_OPERATOR_SET_SCHEMA(
    Scan,
    11,
    OpSchema().FillUsing(Scan_v11_FillSpec).TypeAndShapeInferenceFunction(ScanInferenceFunction));
