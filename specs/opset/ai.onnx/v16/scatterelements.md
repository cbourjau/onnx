---
inherit: v13/scatterelements
since_version: 16
attributes:
  add:
  - name: reduction
    type: string
    doc: 'Type of reduction to apply: none (default), add, mul. ''none'': no reduction
      applied. ''add'':  reduction using the addition operation. ''mul'': reduction
