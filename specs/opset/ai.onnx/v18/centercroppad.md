...
- name: input_data
  type: T
  doc: Input to extract the centered crop from.
  differentiable: true
- name: shape
  type: Tind
  doc: 1-D tensor representing the cropping window dimensions.
...
- name: axes
  type: ints
  doc: If provided, it specifies a subset of axes that 'shape' refer to. If not provided,
    all axes are assumed [0, 1, ..., r-1], where r = rank(data). Negative value means
