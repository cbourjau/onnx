...
def _diff_category(param) -> str | None:
    """Convert a FormalParameter's differentiation_category to a YAML value."""
    ...
    for inp in schema.inputs:
        ...
        inputs.append(
            Variable(
                ...
                doc=inp.description,
                kind=kind,
                differentiation_category=_diff_category(inp),
            )
        )
    ...
    for out in schema.outputs:
        ...
        outputs.append(
            Variable(
                ...
                doc=out.description,
                kind=kind,
                differentiation_category=_diff_category(out),
            )
        )
