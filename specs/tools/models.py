...
SupportLevel = Literal["common", "experimental"]
...
class BaseSpec(BaseModel):
    ...
    def diff(self, child: BaseSpec, inherit: str) -> InheritedSpec:
        ...
        return InheritedSpec(
            ...
            if child.support_level != self.support_level
            else None,
    ...
    def apply_diff(self, diff: InheritedSpec) -> BaseSpec:
        ...
        return BaseSpec(
            ...
            support_level=diff.support_level
            if diff.support_level is not None
            else self.support_level,
            deprecated=diff.deprecated
            if diff.deprecated is not None
